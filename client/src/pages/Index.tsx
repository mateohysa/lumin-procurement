        ...
        <div className="bg-white p-6 rounded-lg border shadow-sm md:col-span-2">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg">
              ...
              <p className="text-sm mt-1">A new tender "IT Infrastructure Upgrade" matches your company profile.</p>
            </div>
            <div className="p-4 bg-yellow-50 border border-yellow-100 rounded-lg">
              <h3 className="font-medium text-yellow-800">Submission Deadline Soon</h3>
              <p className="text-sm mt-1">The "Office Furniture Procurement" tender closes in 3 days.</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-6 rounded-lg border shadow-sm">
          <h2 className="text-lg font-medium mb-4">Submission Stats</h2>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center pb-2 border-b">
              <div className="text-sm text-muted-foreground">Won Tenders</div>
              <div className="font-medium">3</div>
            </div>
            <div className="flex justify-between items-center pb-2 border-b">
              <div className="text-sm text-muted-foreground">Submitted This Month</div>
